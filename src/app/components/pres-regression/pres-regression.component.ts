      ...
      svg.selectAll('path')
        ...
        .on('mouseover', function(d) {
          ...
          .html('<table class=' + 'table table-striped table-sm' + '>'
            + '<thead>'
              + '<tr>'
                + '<th class=' + 'flag ' + 'scope=' + 'col' + '>' + '<img src = ' + d['properties'].flag_image_url + ' onerror' + '= No photo available'
                + '>' + '</th>'
            ...
            + '<tbody>'
            + '<tr>'
              + '<td style=' + 'width: 100px;' + '>' + '<strong>' + 'Actual' + '</strong> </td>'
              + '<td> <strong>' + parseFloat((d['properties'].actual)).toFixed(1) + '%' + '</strong></td>'
            + '</tr>'
            + '<tr>'
              + '<td>' + 'Model' + '</td>'
